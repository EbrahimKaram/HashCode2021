...
P = "the number of streets per Vehicle"
...
def readinput(inputPath, input_file):
    ...
    for (i, line) in enumerate(file):
        ...
        if(i == 0):
            ...
            input_file['Streets'][street_count] = {
                B: street_info[0], E: street_info[1], 'name': street_info[2], L: street_info[3]}
            street_count += 1
...
def streetsAtIntersection(input_file):
    ...
    for s in input_file["Streets"]:
        ...
        street_name = input_parameters['Streets'][s]['name']
...
if __name__ == '__main__':
    ...
    # print(input_files[0])
    # input_parameters = readinput(input_files[0], input_parameters)
